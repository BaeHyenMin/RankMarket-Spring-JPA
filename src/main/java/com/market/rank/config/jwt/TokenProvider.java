...
public class TokenProvider {
    ...
    public String getUsrId(String token) {
        ...
        try {
            ...
            throw new CustomJwtExpiredException("33 "+ e.getMessage());
        }
    }

    public String getToekn(String token) {
        try {
            Claims claims = getClaims(token);
            return claims.get("token", String.class);

        }catch (CustomJwtExpiredException e){
            throw new CustomJwtExpiredException("44 "+ e.getMessage());
        }
    }
    ...
    private Claims getClaims(String token){
        try{
            ...
            throw new CustomJwtExpiredException("token error1 ");
